    ...
    <div class="container-fluid page-body-wrapper">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{url('gerobak')}}">Gerobak Terbelengkai</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('pelanggan')}}">Pelanggan</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('toko')}}">Toko</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('fixedorder')}}">Memperbaiki Pesanan</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="{{url('tambah_kategori')}}">Kategori</a></li>
              </ul>
            </div>
          </li>
        </ul>
      ...
      <footer class="footer">
                  <div class="d-sm-flex justify-content-center justify-content-sm-between">
                     <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">PT. Bos Pangan Group | Admin MarketPlace</span>
