                                        ...
                                        <fieldset>
                                            <div class="row">
                                                <div class="form-group col-md-6 col-lg-6 col-xl-6 d-flex flex-column">
                                                    ...
                                                    <select class="js-example-templating" id='kota' name="id_regencies" data-show-subtext="true" data-live-search="true">
                                                        <option  value="{{$p->id_regencies}}">{{$p->nama_kota}}</option>
                                                        @foreach($kota as $ko)
                                                        <option data-subtext="Rep California" value="{{$ko->id}}">{{ $ko->nama_kota}}</option>
                                                        @endforeach
                                                        @foreach($kabupaten as $kb)
                                                        <option data-subtext="Rep California" value="{{$kb->id}}">{{ $kb->nama_kota}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6 col-lg-6 col-xl-6 d-flex flex-column">
                                                    <label>Kecamatan</label>
                                                    <select id="kecamatan" name="id_districts">
                                                    <option value="{{$p->id_districts}}">{{$p->nama_kecamatan}}</option>
                                                        @foreach($kecko as $ko)
                                                            <option value="{{$ko->id}}">{{ $ko->nama_kecamatan}}</option>
                                                        @endforeach
                                                        @foreach($keckab as $kb)
                                                            <option value="{{$kb->id}}">{{ $kb->nama_kecamatan}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-6 col-lg-6 col-xl-6 d-flex flex-column">
                                                    ...
                                                    <select id="kelurahan" name="id_villages" data-default="">
                                                    <option  value="{{$p->id_villages}}" >{{$p->nama_desa}}</option>
                                                        @foreach($desako as $dko)
                                                            <option value="{{$dko->id}}">{{ $dko->nama_desa}}</option>
                                                        @endforeach
                                                        @foreach($desakab as $dkb)
                                                            <option value="{{$dkb->id}}">{{ $dkb->nama_desa}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
